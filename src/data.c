...
void *load_thread(void *ptr)
{
    ...
    if(a.exposure == 0) a.exposure = 1;//曝光度
    if(a.saturation == 0) a.saturation = 1;//饱和度
    if(a.aspect == 0) a.aspect = 1;//？

    if (a.type == OLD_CLASSIFICATION_DATA){//旧的分类数据
        *a.d = load_data_old(a.paths, a.n, a.m, a.labels, a.classes, a.w, a.h);
    } else if (a.type == REGRESSION_DATA){//回归数据
        *a.d = load_data_regression(a.paths, a.n, a.m, a.classes, a.min, a.max, a.size, a.angle, a.aspect, a.hue, a.saturation, a.exposure);
    } else if (a.type == CLASSIFICATION_DATA){//分类数据
    ...
    } else if (a.type == SUPER_DATA){//上层数据？
        *a.d = load_data_super(a.paths, a.n, a.m, a.w, a.h, a.scale);
    } else if (a.type == WRITING_DATA){//等待数据
        *a.d = load_data_writing(a.paths, a.n, a.m, a.w, a.h, a.out_w, a.out_h);
    } else if (a.type == INSTANCE_DATA){//实例数据
